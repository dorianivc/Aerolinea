...
public class Seleccion_de_Asientos {
    ...
    public static void main(String[] args) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
       ...
       Model model= new Model(6,6);//AQUI ES DONDE LE PASO LA CANTIDAD DE FILAS Y COLUMNAS
       ...
       JOptionPane.showMessageDialog(null,"Clickee sobre los asientos que desea reservar una vez, cambiaran de color negro a blanco."+ "\n"+"Si deseea revertir la eleccion, solamente vuelva a dar click sobre el asiento para desmarcarlo. Luego presiona aceptar" , "INSTRUCCIONES DE ELECCION DE ASIENTO",JOptionPane.PLAIN_MESSAGE);
